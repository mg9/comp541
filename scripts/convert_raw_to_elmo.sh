...
allennlp elmo --all --options-file big.options --weight-file elmo_2x4096_512_2048cnn_2xhighway_5.5B_weights.hdf5  --cuda-device 0 /kuacc/users/mugekural/workfolder/comp541/scripts/raw.test.txt /kuacc/users/mugekural/workfolder/comp541/scripts/elmo-layers.ptb3-test.hdf5
